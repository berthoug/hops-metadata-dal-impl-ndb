...
public class ContainersLogsClusterJ implements
    ...
    @Override
    public void addAll(Collection<ContainersLogs> containersLogs) throws StorageException {
    ...
    public Map<String, ContainersLogs> getAll() throws StorageException {
        ...
        HopsQueryDomainType<ContainersLogsDTO> dobj =
            qb.createQueryDefinition(ContainersLogsDTO.class);
    ...
    @Override
    public Map<String, ContainersLogs> getByExitStatus(int exitstatus) throws StorageException {
        HopsSession session = connector.obtainSession();
        HopsQueryBuilder qb = session.getQueryBuilder();
    ...
    private static Map<String, ContainersLogs> createMap(List<ContainersLogsDTO> results) {
